...
import guru.sfg.brewery.model.events.DeallocateOderRequest;
...
public class BeerOrderManagerImplIT {
    ...
    void testAllocatedToCancel() throws JsonProcessingException {
        ...
        DeallocateOderRequest  deallocateOderRequest = (DeallocateOderRequest) jmsTemplate.receiveAndConvert(JmsConfig.DEALLOCATE_ORDER_QUEUE);
        assertNotNull(deallocateOderRequest);
        assertThat(deallocateOderRequest.getBeerOrderDto().getId()).isEqualTo(savedBeerOrder.getId());
    }
